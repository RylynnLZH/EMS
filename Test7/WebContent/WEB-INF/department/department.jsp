...
<script type="text/javascript">
	$().ready(function() {
		...
		$(".del").click(function() {
			...
			if (length > 0) {
				var con = confirm("确认删除？");
						if (con) {
							window.location.href = "department?type=del&ids="+ ids;
						}
			} else {
				alert("请选中至少一行数据");
			}
		...
		$(".update").click(function() {
			...
			window.location.href = "department?type=update&deps="+ js;
			...
			$(".search").click(function(){
				...
				window.location.href="department?type=search&depname="+depname+"&depcount="+depcount+"&nowpage="+${p.nowpage};
			})
...
$().ready(function(){
	...
	var str ="department?type=search&depname="+name+"&count="+depcount+"&nowpage=";
